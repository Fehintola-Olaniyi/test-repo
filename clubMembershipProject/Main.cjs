const prompt = require("prompt-sync")();
  ...
  get dateOfRegistration() {
    ...
    return `${this.fullName} is now registered as a ${this.status} at ${this._dateOfRegistration}`;
  }
...
class Staff extends Member {
  constructor(first, last, gender, dateOfBirth, phoneNumber, emailAddress, staffNo) {
    super(first, last, gender, dateOfBirth, phoneNumber, emailAddress);
    this.status = "Staff";
